...
function page() {
  metadata.title = 'About | Victory Analytica & Security LLC';
  metadata.description = "Victory Analytica & Security LLC redefines international business consulting through integrated security solutions and data-driven strategy. We specialize in turnkey US market entry, combining legal expertise with cutting-edge threat analysis to safeguard your global expansion.";
  metadata.icons = {
    icon: "/favicon.ico",
  }
  return (
