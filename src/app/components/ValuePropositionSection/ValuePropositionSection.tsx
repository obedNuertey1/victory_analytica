...
const valueCards = [
  {
    ...
    backgroundSrc: "/assets/ValueProposition/ValueProposition/matt-white-bg.png",
    imageSrc: "/assets/ValueProposition/ValueProposition/image-1.png",
  },
  {
    title: "Strategic Market Entry",
    description: "Complete U.S. business setup including registration, banking, and California State ID assistance",
    backgroundSrc: "/assets/ValueProposition/ValueProposition/matt-white-bg.png",
    imageSrc: "/assets/ValueProposition/ValueProposition/image-2.png",
  },
  {
    title: "Asset Optimization",
    description: "Full-spectrum asset management from vendor sourcing to property acquisition under Elite Model guidance",
    backgroundSrc: "/assets/ValueProposition/ValueProposition/matt-white-bg.png",
    imageSrc: "/assets/ValueProposition/ValueProposition/image-3.png",
  },
  {
    ...
    backgroundSrc: "/assets/ValueProposition/ValueProposition/matt-white-bg.png",
    imageSrc: "/assets/ValueProposition/ValueProposition/image-4.png",
  },
];
  ...
  return (
    ...
    >
      ...
      <motion.div 
        ...
        style={{ y }}
      >
        <svg width="1440" height="1312" className="object-cover w-full h-full scale-y-[-1]" viewBox="0 0 1440 1312" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g opacity="0.6">
