...
export const Background = () => {
  return (
    <div className="absolute inset-0 -z-10">
      <Image
        src="/assets/HeroSection/Background/matt-white-bg.png"
      ...
      <svg width="1440" className="object-cover absolute inset-0 size-full" height="1024" viewBox="0 0 1440 1024" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <defs>
          <filter id="filter0_f_0_604" x="113.6" y="-4.42343" width="1212.8" height="1030.82" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
